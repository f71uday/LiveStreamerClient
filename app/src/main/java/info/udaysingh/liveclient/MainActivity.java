package info.udaysingh.liveclient;
...
public class MainActivity extends AppCompatActivity implements IVLCVout.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
         StreamPath = "rtsp://192.168.42.159:1935/android_test/myStream";
        mSurface = findViewById(R.id.surafce);
        ...
        public void onEvent(MediaPlayer.Event event) {
            ...
            switch (event.type) {
                case MediaPlayer.Event.EndReached:
                    Log.d("MainActivity", "MediaPlayerEndReached");
